...
namespace Silver
{
	namespace UI
	{
		[CustomEditor(typeof(CanvasRenderModeVR), true)]
		[CanEditMultipleObjects]
		public class CanvasRenderModeVREditor : Editor
		{
			SerializedProperty m_PlaneDistance;
			SerializedProperty m_UpdatePosition;
			...
			protected virtual void OnEnable()
			{
				...
				m_UpdatePosition = serializedObject.FindProperty("m_UpdatePosition");
